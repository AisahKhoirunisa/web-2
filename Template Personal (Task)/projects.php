                ...
                <div class="container px-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                            <li class="nav-item"><a class="nav-php" href="index.php">Home</a></li>
                            <li class="nav-item"><a class="nav-php" href="resume.php">Resume</a></li>
                            <li class="nav-item"><a class="nav-php" href="projects.php">Projects</a></li>
                            <li class="nav-item"><a class="nav-php" href="contact.php">Contact</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
                            ...
                            <div class="card overflow-hidden shadow rounded-4 border-0 mb-5">
                                <div class="card-body p-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <img class="img-fluid" src="assets/Desain.png" alt="..." style="width: 300px; height: 400px;" />
                                    </div>
                                </div>
                            </div>
                        </div>
